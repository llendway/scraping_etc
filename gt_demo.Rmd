...
Add footnotes to some of the `currency` values. Many functions, like `cells_data()` (in newer versions of R, this is now called `cells_body()`), to help find the right cells. They all start with `cells_`.
